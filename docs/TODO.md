...
- [x] Homepage hero uses the owner's own 20-second molecule clip (`public/videos/hero-molecules.mp4`): right 60% on desktop fading into the copy, behind the headline on phones. The generated biotech video was removed at the owner's request.
