    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-fadeIn">
      ...
      >
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
          <div className="w-12 h-12 rounded-2xl bg-amber-950/80 border border-amber-500/40 flex items-center justify-center text-amber-400 flex-shrink-0">
        ...
        <div className="p-4 rounded-xl bg-brand-darker border border-brand-border text-xs text-gray-300 space-y-3 leading-relaxed">
          <p>
            Please confirm and acknowledge the following conditions before accessing this catalog:
          </p>
          <ul className="space-y-2 text-left text-[11px] text-gray-300">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400 cursor-pointer justify-center sm:justify-start" onClick={() => setRemember(!remember)}>
          <input
            type="checkbox"
            checked={remember}
