    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div>
        ...
        {preview ? (
          <div className="overflow-hidden border border-black/25 bg-flag-red">
            <div className="whitespace-nowrap px-4 py-2 font-display text-[0.625rem] font-extrabold uppercase tracking-[0.14em] text-white">
              {preview}
            </div>
          </div>
        ) : (
          <p className="border border-dashed border-brand-border p-4 text-center text-[0.625rem] text-brand-textMuted">
              ...
              <div className="mb-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className={`inline-flex items-center gap-1 px-2 py-0.5 font-display text-[0.5625rem] font-black uppercase tracking-[0.1em] transition-colors ${
                      b.isActive
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-brand-border pt-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-2 font-display text-[0.625rem] font-extrabold uppercase tracking-[0.1em] text-brand-textMuted transition-colors hover:text-brand-accentGlow"
        >
          <ExternalLink className="h-3 w-3" /> Open the website
        </a>

        {saved && (
          <span className="font-display text-[0.625rem] font-extrabold uppercase tracking-[0.1em] text-whatsapp">
            Published — reload the site to see it
          </span>
        )}
        {error && <span className="text-[0.6875rem] text-brand-accentGlow">{error}</span>}
      </div>
    </div>
  );
}
