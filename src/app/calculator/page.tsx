...
export default function CalculatorPage() {
  return (
    <div className="shell py-10 space-y-10">
      ...
      <div className="p-6 rounded-2xl bg-brand-card border border-brand-border space-y-4 text-xs text-brand-body">
        <h3 className="text-sm font-bold text-brand-heading flex items-center gap-2">
          <HelpCircle className="w-4 h-4 text-brand-accentGlow" />
        ...
        <div className="p-4 rounded-xl bg-brand-darker border border-brand-border font-mono text-brand-accentGlow space-y-2">
