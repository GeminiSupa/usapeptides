    ...
    <div className="shell py-10 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-4 text-xs sm:text-sm text-gray-300 leading-relaxed">
          ...
          <p>
            Battle Born Peptides was founded to eliminate the variance and lack of transparency historically associated with research chemical procurement. We believe researchers deserve clear, reproducible purity data before running critical in-vitro assays.
          </p>
          <p>
